...
export const books: Book[] = [
  ...
  {
    id: "46",
    title: "Artificial Intelligence: Foundations and Frontiers",
    author: "Dr. Layla Al-Farouqi",
    description:
      "Comprehensive exploration of AI fundamentals, including machine learning, natural language processing, robotics, and the ethical challenges of AI in society.",
    price: 89.5,
    image: "/images/book4.jpg",
    isbn: "978-9876543210",
    genre: ["Computer Science", "Artificial Intelligence"],
    tags: ["AI", "Machine Learning", "Robotics", "Ethics"],
    datePublished: "2024-05-10",
    pages: 640,
    language: "English",
    publisher: "Future Minds Press",
    rating: 4.6,
    reviewCount: 24,
    inStock: true,
    featured: false,
